...
/**
 *  Subscriber helper implementations for PerformanceBench precompute model.
 */
public final class SubscriberHelpers {
    ...
    public abstract static class ObservableSubscriber<T> implements Subscriber<T> {
         ...
         * @return this
         */
        public com.mongodb.devrel.pods.performancebench.models.apimonitor_precompute.SubscriberHelpers.ObservableSubscriber<T> await() {
         ...
         * @return this
         */
        public com.mongodb.devrel.pods.performancebench.models.apimonitor_precompute.SubscriberHelpers.ObservableSubscriber<T> await(final long timeout, final TimeUnit unit) {
     ...
     * @param <T> The publishers result type
     */
    public static class OperationSubscriber<T> extends com.mongodb.devrel.pods.performancebench.models.apimonitor_regionquery.SubscriberHelpers.ObservableSubscriber<T> {
     ...
     * @param <T> The publishers result type
     */
    public static class PrintSubscriber<T> extends com.mongodb.devrel.pods.performancebench.models.apimonitor_regionquery.SubscriberHelpers.OperationSubscriber<T> {
     ...
     */
    public static class PrintDocumentSubscriber extends com.mongodb.devrel.pods.performancebench.models.apimonitor_regionquery.SubscriberHelpers.ConsumerSubscriber<Document> {
        /**
     ...
     */
    public static class PrintToStringSubscriber<T> extends com.mongodb.devrel.pods.performancebench.models.apimonitor_regionquery.SubscriberHelpers.ConsumerSubscriber<T> {
        /**
         * Construct a new instance
         */
     ...
     * @param <T> the type of the element
     */
    public static class ConsumerSubscriber<T> extends com.mongodb.devrel.pods.performancebench.models.apimonitor_regionquery.SubscriberHelpers.OperationSubscriber<T> {
