...
public class TestOptions extends Document {
	...
	TestOptions(String[] args) throws ParseException {
		...
		String[] integerParamaters = { "size", "customers", "orders", "items", "products", "threads", "itterations" };
		Document integerDefaults = Document
				.parse("{size:4096,customers:10000,orders:20,items:5,products:10000,itterations:50000}");
